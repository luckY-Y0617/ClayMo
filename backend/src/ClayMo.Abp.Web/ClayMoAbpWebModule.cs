using ClayMo.Abp.Application;
using ClayMo.Abp.SqlSugar;
using ClayMo.Framework.AspNetCore;
using ClayMo.Framework.AspNetCore.Extensions;
using ClayMo.Framework.AspNetCore.MultiTenancy;
using ClayMo.Framework.Authentication;
using ClayMo.Framework.Authorization;
using ClayMo.Framework.BackgroundJobs.Hangfire;
using ClayMo.Framework.Core;
...
public class ClayMoAbpWebModule : AbpModule
{
    public override Task PreConfigureServicesAsync(ServiceConfigurationContext context)
    {
        PreConfigure<AbpAspNetCoreMvcOptions>(options =>
        {
            ...
            options.ConventionalControllers.Create(
                typeof(WorkSpaceApplicationModule).Assembly,
                option => option.RemoteServiceName = "WorkSpace");
        });

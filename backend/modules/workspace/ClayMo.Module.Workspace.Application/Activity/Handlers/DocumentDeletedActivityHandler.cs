...
public class DocumentDeletedActivityHandler
    : ILocalEventHandler<DocumentDeletedActivityEvent>,
        ITransientDependency
{
    ...
    public DocumentDeletedActivityHandler(
    ...
    public virtual async Task HandleEventAsync(DocumentDeletedActivityEvent eventData)
    {
        ...
        var log = new ActivityLog(
            ...
            action: WorkspaceActivityActionNames.Document.Deleted,
            objectType: "doc",

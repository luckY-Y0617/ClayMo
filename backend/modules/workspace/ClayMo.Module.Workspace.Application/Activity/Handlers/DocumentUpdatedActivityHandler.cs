...
public class DocumentUpdatedActivityHandler
    : ILocalEventHandler<DocumentUpdatedActivityEvent>,
        ITransientDependency
{
    ...
    public DocumentUpdatedActivityHandler(
    ...
    public virtual async Task HandleEventAsync(DocumentUpdatedActivityEvent eventData)
    {
        var payload = JsonSerializer.Serialize(new
        {
            eventData.Title,
            eventData.ChangeSummary,
        ...
        var log = new ActivityLog(
            ...
            action: WorkspaceActivityActionNames.Document.Updated,
            objectType: "doc",

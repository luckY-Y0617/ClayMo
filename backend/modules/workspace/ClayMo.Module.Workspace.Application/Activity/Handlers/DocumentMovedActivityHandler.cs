...
public class DocumentMovedActivityHandler
    : ILocalEventHandler<DocumentMovedActivityEvent>,
        ITransientDependency
{
    ...
    public DocumentMovedActivityHandler(
    ...
    public virtual async Task HandleEventAsync(DocumentMovedActivityEvent eventData)
    {
        var payload = JsonSerializer.Serialize(new
        {
            eventData.FromParentId,
            eventData.ToParentId,
            eventData.ToOrder,
        ...
        var log = new ActivityLog(
            ...
            action: WorkspaceActivityActionNames.Document.Moved,
            objectType: "doc",

...
using ClayMo.Framework.Authentication;
using ClayMo.Framework.Authentication.Abstractions.Http;
using ClayMo.Framework.Authentication.Token;
using ClayMo.Framework.AspNetCore.Logging;
...
using ClayMo.Module.Identity.Domain.Identities.Repositories;
using ClayMo.Module.Identity.Domain.Shared.Enums;
using ClayMo.Module.Identity.Domain.Shared.Errors;
using ClayMo.Module.Identity.Domain.Shared.Events;
...
namespace ClayMo.Module.Identity.Application.Identitys;

...
using ClayMo.Module.Knowledge.Application.Contracts.KnowledgeBases;
...
namespace ClayMo.Module.Knowledge.Application.KnowledgeBases;
...
public class KnowledgeBaseAppService : ApplicationService, IKnowledgeBaseAppService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await _localEventBus.PublishAsync(
            new KnowledgeBaseCreatedActivityEvent(

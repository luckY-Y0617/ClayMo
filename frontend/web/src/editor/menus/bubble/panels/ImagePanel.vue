<template>
  <div class="kb-image-panel" @mousedown.stop>
    ...
    <!-- 重置大小 -->
    <button class="kb-panel-btn" title="重置大小" @click="resetSize">
      <svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none">
    ...
    <!-- 全屏预览 -->
    <button class="kb-panel-btn" title="全屏预览" @click="previewImage">
      <svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none">
    ...
    <!-- 评论 -->
    <button class="kb-panel-btn" title="添加评论" @click="addComment">
      <svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none">

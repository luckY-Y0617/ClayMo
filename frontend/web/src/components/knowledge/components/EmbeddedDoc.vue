  ...
  <div class="embedded-doc">
    ...
    >
      ...
      <div class="meta">
        ...
        <div v-if="docTags.length" class="tags">
          <el-tag
...
const emit = defineEmits<{
  'open': [doc: DocumentData]
}>()

const loading = ref(false)
const docData = ref<DocumentData | null>(props.document)

const docTags = computed(() => docData.value?.tags || [])
...
const fetchDoc = async (id: string) => {
  ...
  try {
    ...
    docData.value = doc as DocumentData
  } catch (error) {

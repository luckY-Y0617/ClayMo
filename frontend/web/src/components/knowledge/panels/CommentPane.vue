<template>
  <div class="comment-pane">
    ...
    <el-scrollbar ref="commentListRef" class="comment-pane__list">
      ...
      <ul v-else>
        ...
        >
          ...
          <div class="comment-item__body">
            ...
            <div v-if="commentReplies(comment).length" class="replies">
              <div
                v-for="reply in commentReplies(comment)"
                :key="reply.id"
                class="reply"
              >
...
const draft = ref('')
const commentListRef = ref<InstanceType<typeof import('element-plus')['ElScrollbar']> | null>(null)

const commentReplies = (comment: Comment): Reply[] => {
...
// 监听评论导航事件
const handleCommentPaneNavigate = (event: Event) => {

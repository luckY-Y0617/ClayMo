<template>
  <section class="tool-page">
    ...
    <main class="page-content">
      <ImageMontage @export="handleExport" />
    </main>
      ...
      <div class="modal-card" @click.stop>
        ...
        <div class="modal-body">
          <div class="help-section">
            <h4>基本操作</h4>
            <ul>
              <li>点击"添加图片"选择要拼贴的图片，支持批量选择</li>
              <li>拖拽图片到画布上进行布局</li>
              <li>选中图片后可以调整位置、大小、旋转角度和透明度</li>
              <li>使用右侧面板调整画布尺寸和图片属性</li>
              <li>点击"导出 PNG"保存拼贴画作品</li>
            </ul>
          </div>
          <div class="help-section">
            <h4>图片编辑</h4>
            <ul>
              <li>拖拽图片四角的控制点调整大小</li>
              <li>拖拽图片本身移动位置</li>
              <li>使用滑块调整旋转角度（0-360度）</li>
              <li>使用滑块调整透明度（0-100%）</li>
              <li>点击图片右上角的删除按钮移除图片</li>
            </ul>
          </div>
          <div class="help-section">
            <h4>画布设置</h4>
            <ul>
              <li>支持多种预设画布尺寸（全高清、正方形等）</li>
              <li>可自定义画布宽度和高度</li>
              <li>画布尺寸范围：100-4000像素</li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <!-- 导出成功提示 -->
    <div v-if="exportSuccess" class="toast-success">
...
<script setup>
import { ref } from 'vue'
import ImageMontage from '@/components/image/ImageMontage.vue'
